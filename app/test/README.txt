...
>>> transfer "1.2.15" "1.2.0" 1 "LD" "memo" true

In these unit tests the "import_key" step is not necessary because the
genesis key is saved in the source code.

An inspection of account 1.2.15 gives usefull information:
Graphene > $g.db.api.exec("get_objects",[["1.2.15"]])
var o=_[0]
o.active
...
ex: short_sell_asset 1.2.15 1000 USD 1000 true
...
var trx = ["short_order_cancel", {"fee_paying_account": "1.2.15","order": "1.9.3"}]
...
var trx = ["asset_issue", {"issuer":"1.2.15","asset_to_issue":{"amount":"1245470","asset_id":"1.3.2"},"issue_to_account":"1.2.15"}]
...
var trx = ["delegate_create", {"delegate_account":"1.2.15"}];
