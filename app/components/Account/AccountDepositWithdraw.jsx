...
class AccountDepositWithdraw extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            rudexServiceBEP20: props.viewSettings.get(
                "rudexServiceBEP20",
                "gateway"
            ),
    ...
    shouldComponentUpdate(nextProps, nextState) {
        return (
            ...
            nextState.rudexServiceBEP20 !== this.state.rudexServiceBEP20 ||
            nextState.activeService !== this.state.activeService ||
            nextState.RudexNoticeInformed !== this.state.RudexNoticeInformed ||
            nextState.RudexNoticeInformed_BuyCrypto !==
                this.state.RudexNoticeInformed_BuyCrypto ||
    ...
    onRudexNoticeInformed_BuyCrypto() {
        this.setState({
            RudexNoticeInformed_BuyCrypto: !this.state
                                ...
                                <div>
                                    ...
                                    <h5>
                                        <input
                                            type="checkbox"
                                            defaultChecked={
                                                this.state.RudexNoticeInformed
                                            }
                                            onChange={this.onRudexNoticeInformed.bind(
                                                this
                                            )}
                                        />{" "}
                                        -{" "}
                                ...
                                <div>
                                    ...
                                    <h5>
                                        <input
                                            ...
                                            onChange={this.onRudexNoticeInformed_BuyCrypto.bind(
                                                this
                                            )}
                                        />{" "}
                                        -{" "}
                ...
                template: (
                    <div className="content-block">
                        ...
                        >
                            <ul className="button-group segmented no-margin">
                                <li
                                    onClick={this.toggleRuDEX_BEP20Service.bind(
                                        this,
                                        "gateway"
                                    )}
                                    className={
                                        rudexServiceBEP20 === "gateway"
                                            ? "is-active"
                                            : ""
                                    }
                                >
    ...
    render() {
        ...
        let rudexGatewayCoinsBEP20 = this.props.rudexBackedCoinsBEP20
            .map(coin => {
                return coin;
            })
            .sort((a, b) => {
