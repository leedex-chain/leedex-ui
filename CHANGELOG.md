...
- Update leedexjs to enable new orders api
...
- Update leedexjs for better handling of incoming proposed transactions
...
- Update leedexjs to fix proposals array undefined error
...
- Update leedexjs, fixes vesting balances not loading properly
...
- Change Graphene to Graphene
- Replace graphenejs-lib with leedexjs
- Fix npm errors
...
Bug fixes
--------
- Add Graphene bloom filter for BTS 1 account imports
...
- Update the Blocktrades bridge code to use the correct wallet symbols for MKR on the Graphene blockchain
